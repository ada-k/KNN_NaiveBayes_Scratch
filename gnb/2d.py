...
"""
Same as 1d but with Naïve Bayes
Compare the results of the two classifiers
(i.e., the results form 1 c) and 1d) with the ones from 2 c) 2d) and
...
# comment
"""
Using less features result in a signifiicantly lower
accuracy due to less data for the model to learn on.
"""